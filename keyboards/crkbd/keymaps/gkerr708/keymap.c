...
bool oled_task_user(void) {
    // Check if the keyboard is the master side
    if (is_keyboard_master()) {
        // Display keyboard name and firmware version
        oled_write_P(PSTR("CRKBD (v1.13)\n"), false);

        // Get the active layer and display its name
        switch (get_highest_layer(layer_state)) {
            case 0:
                oled_write_P(PSTR("Layer: MAIN\n"), false);
                break;
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                oled_write_P(PSTR("Layer: CSGO\n"), false);
                break;
            case 4:
                oled_write_P(PSTR("Layer: SCII (A)\n"), false);
                break;
            case 5:
                oled_write_P(PSTR("Layer: SCII (B)\n"), false);
                break;
            case 6:
                oled_write_P(PSTR("Layer: DOTA (A)\n"), false);
                break;
            case 7:
                oled_write_P(PSTR("Layer: DOTA (B)\n"), false);
                break;
            default:
        ...
        // Display a static message for the non-master side
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LSFT(KC_GRV),    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_DEL,
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          _______, _______, _______,    KC_LGUI, KC_CAPS, _______
                                      //`--------------------------'  `--------------------------'
  ),
    // NAV
